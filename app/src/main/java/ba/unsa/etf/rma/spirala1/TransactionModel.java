...
public final class TransactionModel {
    ...
    static {
        ...
        transactions.add(new Transaction(LocalDate.of(2020,3,11),144,"DvadesetTreca",PURCHASE,"Ne Znam sta da kazem",0,null));
        transactions.add(new Transaction(LocalDate.of(2020,4,13),122,"DvadesetCet",REGULARPAYMENT,"Ne Znam sta da kazem",0,LocalDate.of(2020,5,3)));
