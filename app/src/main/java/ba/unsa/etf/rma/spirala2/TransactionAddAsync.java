...
public class TransactionAddAsync extends AsyncTask<Transaction, Integer, Void> {
    public ArrayList<Transaction> trans;
  //  private onAddingDone caller;

  //  public TransactionAddAsync(onAddingDone p) {
  //      caller = p;
  //  };
    public TransactionAddAsync(){

    }
/*
    public interface onAddingDone{
        public void onDodaj();
    }
...
*/
    ...
    protected Void doInBackground(Transaction... transactions) {
        ...
        URL url = null;
        try {
            url = new URL("http://rma20-app-rmaws.apps.us-west-1.starter.openshift-online.com/account/e2787b43-9b9b-4e23-9629-65b08770b738/transactions");
