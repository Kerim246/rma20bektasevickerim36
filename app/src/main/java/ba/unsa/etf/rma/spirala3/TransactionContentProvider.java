...
public class TransactionContentProvider extends ContentProvider {
    ...
    public int delete(@NonNull Uri uri, @Nullable String s, @Nullable String[] strings) {
        ...
        int id = database.delete(TransactionDBOpenHelper.TRANSACTION_TABLE,s,strings);
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues contentValues, @Nullable String s, @Nullable String[] strings) {
        ...
        int id = database.update(TransactionDBOpenHelper.TRANSACTION_TABLE,contentValues,s,strings);
